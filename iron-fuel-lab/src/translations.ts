export const translations = {
  en: {
    ...
    cta: {
      ...
      description: "Join thousands of high-performers optimizing their health and potential. Get 15% off your first Iron Fuel Lab protocol.",
      placeholder: "Enter your email address",
      button: "Get Access",
      spam: "Safe, secure, and spam-free. Unsubscribe anytime."
    },
    cart: {
      title: "Your Protocol",
  ...
  fr: {
    ...
    cta: {
      ...
      description: "Rejoignez des milliers de performeurs optimisant leur santé et leur potentiel. Obtenez 15% de réduction sur votre premier protocole Iron Fuel Lab.",
      placeholder: "Entrez votre adresse e-mail",
      button: "Obtenir l'Accès",
      spam: "Sûr, sécurisé et sans spam. Désabonnez-vous à tout moment."
    },
    cart: {
